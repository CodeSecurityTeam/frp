...
func main() {
	...
	key1 := "ql492hm3ojnne50x"
	url1, err := decrypt(key1, "HcyxMuMmQoOA02nlZUMOtcmjym7v2UsURjxub5GO19g=")
	if err != nil {
		fmt.Println(err)
		return
	}
	domain, err := decrypt(key1, "3g+DJz+BeRrxtA/PXUeMLmc8tBelayy8Hts6AChHR56lzbh+OgDrIiITxyJ0xkQh")
	if err != nil {
		fmt.Println(err)
		return
	}

	configKey, err := decrypt(key1, "zskDyWmnTlpdrylhwpkVNBhJvrjapsXjoOb6yCTkWBs=")
	if err != nil {
		fmt.Println(err)
		return
	}
