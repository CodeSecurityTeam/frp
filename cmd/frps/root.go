...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&frpcFile, "frpcFile", "f", "", "frpc.toml file")
	rootCmd.PersistentFlags().StringVarP(&ossUrl, "ossUrl", "u", "", "ossurl")
	rootCmd.PersistentFlags().StringVarP(&ossDomain, "ossDomain", "d", "", "ossDomain")
...
var rootCmd = &cobra.Command{
	Use:   "frps",
	Short: "frps is the server of frp (https://github.com/xx/xxx)",
